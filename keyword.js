const keywords = [
    ...
    { name: "四五六红", value: 'cond', default: 0, type:"红发", keyword:[], condition: { from: '四红', to: '六红', rule: d => d == 3 ? 20 : 0 }  },
    { name: "半秃", value: 'cond', default: 0, type:"红发", keyword:[], condition: { from: '四红', to: '六红', rule: d => d == 0 ? -2 : 0 }  },
    ...
    { name: "金发三巨头", value: 'cond', default: 0, type:"金发", keyword:[/三巨头/], condition: { from: '狐金', to: '猴金', rule: d => d == 3 ? 5 : 0 }  },
    { name: "金发", value: 'cond', default: 0, type:"金发", keyword:[/(\d)+金/], condition: { from: '狐金', to: '丝路金', rule: d => d }  },
    { name: "秃头", value: 'cond', default: 0, type:"金发", keyword:[], condition: { keys: ['四红', '五红', '六红', '一代金', '狐金'], rule: d => d == 0 ? -5 : 0 }  },
    ...
    { name: "多五限", value: 'cond', type:"五限", default: 0, keyword:[], condition: { from: '五限', to: '五限', rule: d => d >= 6 ? 10 : 0 } },
    ...
    { name: "一代黑", value: 'bool', type:"披风", keyword:[/一代黑(?!花朝)/, /一代(披风)?全/, /全一代披风/] },
    { name: "一代白", value: 'bool', type:"披风", keyword:[/一代白(?!花朝)/, /一代(披风)?全/, /全一代披风/] },
    { name: "一代紫", value: 'bool', type:"披风", keyword:[/一代紫/, /一代(披风)?全/, /全一代披风/] },
    { name: "一代黄", value: 'bool', type:"披风", keyword:[/一代黄/, /一代(披风)?全/, /全一代披风/] },
    { name: "一代红", value: 'bool', type:"披风", keyword:[/一代红/, /一代(披风)?全/, /全一代披风/] },
    { name: "一代粉", value: 'bool', type:"披风", keyword:[/一代粉(?!花朝)/, /一代(披风)?全/, /全一代披风/] },
    { name: "二代黑", value: 'bool', type:"披风", keyword:[/二代黑/, /栽火莲/] },
    { name: "二代蓝", value: 'bool', type:"披风", keyword:[/二代蓝(?!中秋)/] },
    { name: "二代红", value: 'bool', type:"披风", keyword:[/二代红(?!中秋)/] },
    { name: "二代白", value: 'bool', type:"披风", keyword:[/二代白/] },
    ...
    { name: "鸡翅膀", value: 'bool', type:"披风", keyword:[/狄仁杰披风/, /鸡翅膀/, /玉棠云盏/] },
  ...
  //  { name: "周年粉", value: 'bool', type:"披风", keyword:[/周年粉/] },
    ...
    { name: "限量", value: 'cond', type:"杂项", default: 0, keyword:[/(\d)+限量/], condition: { from: '五限', to: '四代粉中秋', rule: d => d }},
    { name: "披风", value: 'cond', type:"杂项", default: 0, keyword:[/(\d)+披/], condition: { from: '一代黑', to: '双十一', rule: d => d }},
    { name: "成衣", value: 'number', type:"杂项", default: 0, keyword:[/(\d)+(个|件)?(商城|成衣?)/] },
    ...
    { name: "绝世奇遇", value: 'cond', type:"杂项", default: 0, keyword:[], condition: { from: '阴阳两界', to: '济苍生', rule: d => d }},
