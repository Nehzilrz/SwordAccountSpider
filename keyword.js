let keywords = [
  ...
  { name: "金陵", type: "六限", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "金螺母", type: "其他", alias: [], regs: [], tier: 0 },
  { name: "富婆套", type: "其他", alias: ["任侠河山"], regs: [], tier: 0 },
  { name: "望月", type: "其他", alias: [], regs: [], tier: 0 },
  { name: "兰亭", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "九壤", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "禹梦", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "长天", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "舞步", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "封川", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "沐云飞", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "水云寒", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "微草", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "玫瑰", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "重天", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "暮归", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "锦夜游", type: "其他", max_value: 6, alias: [], regs: [], tier: 0 },
  { name: "踏月", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "雪月", type: "其他", alias: ["49套", "工作服"], regs: [], tier: 0 },
  { name: "打歌服", type: "其他", alias: [], regs: [], tier: 0 },
  { name: "寒梅", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "望云", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "中宵", type: "其他", max_value: 6, alias: [], regs: [], tier: 0 },
  { name: "牵云", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "兰若", type: "其他", max_value: 4, alias: [], regs: [], tier: 0 },
  { name: "月寒", type: "其他", max_value: 6, alias: [], regs: [], tier: 0 },
  { name: "飒西风", type: "其他", max_value: 6, alias: [], regs: [], tier: 0 },
  ...
  { name: "腿盒", type: "礼盒", max_value: 3, alias: [], regs: [], tier: 0 },
  ...
  { name: "狐狸毛", type: "披风", max_value: 2, alias: [], regs: [], tier: 0 },
  { name: "孔雀", type: "披风", alias: [], regs: [], tier: 0 },
  { name: "天辉", type: "披风", alias: [], regs: [], tier: 0 },
  { name: "白莲花", type: "披风", alias: [], regs: [], tier: 0 },
  { name: "喵萝干", type: "披风", max_value: 2, alias: [], regs: [], tier: 0 },
  { name: "毒萝干", type: "披风", max_value: 2, alias: [], regs: [], tier: 0 },
  { name: "双十一", type: "披风", max_value: 6, alias: [], regs: [], tier: 0 },
  ...
  { name: "红发", type: "统计", max_value: 20, alias: [], regs: [], tier: 1 },
  { name: "金发", type: "统计", max_value: 20, alias: [], regs: [], tier: 1 },
  { name: "白发", type: "统计", max_value: 100, alias: [], regs: [], tier: 1 },
  { name: "黑发", type: "统计", max_value: 100, alias: [], regs: [], tier: 1 },
  { name: "盒子", type: "统计", max_value: 100, alias: [], regs: [], tier: 1 },
  { name: "五限", type: "统计", max_value: 32, alias: [], regs: [], tier: 1 },
  { name: "限量", type: "统计", max_value: 320, alias: [], regs: [], tier: 1 },
  { name: "披风", type: "统计", max_value: 200, alias: [], regs: [], tier: 1 },
  { name: "脚印", type: "统计", max_value: 20, alias: [], regs: [], tier: 1 },
  { name: "五甲", type: "统计", max_value: 300, alias: [], regs: [], tier: 1 },
  { name: "一代披风", type: "统计", max_value: 6, alias: [], regs: [], tier: 1 },
  { name: "资历", type: "统计", max_value: 30, alias: [], regs: [], tier: 1 },
  { name: "十万资历", type: "统计", max_value: 1, alias: [], regs: [], tier: 1 },
  { name: "奇遇", type: "统计", max_value: 30, alias: [], regs: [], tier: 1 },
  { name: "绝世奇遇", type: "统计", max_value: 10, alias: [], regs: [], tier: 1 },
]
...
keywords.forEach((d, i) => {
  ...
  if (d.max_value == undefined) d.max_value = 1
...
const rules = [
  ...
  (s, x) => {
    for (let i = 0; i < keywords.length; ++i) {
      if (x[i] > keywords[i].max_value) {
        x[i] = keywords[i].max_value
      }
    }
    return 1
  },
  (s, x) => {
    ...
    x[K('盒子')] = T('礼盒').map(d => x[d]).reduce((a, b) => a + b)
