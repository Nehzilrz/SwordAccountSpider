...
const bodys = [
    { name: "萝莉", value: 'bool', type:"体型", keyword:[/萝莉/, /咩萝/, /秀萝/, /花萝/, /毒萝(?!干)/, /琴萝/, /鸽萝/, /喵萝(?!干)/, /军萝/, /盾萝/, /伞萝/, /叽萝/, /歌萝/, /鸡萝/, /炮萝/, /丐萝/, /刀萝/]},
    { name: "成女", value: 'bool', type:"体型", keyword:[/成女/, /道姑/, /秀姐/, /花姐/, /毒姐/, /琴姐/, /琴娘/, /喵姐/, /军娘/, /盾姐/, /盾娘/, /伞(娘|姐)/, /二小姐/, /炮姐/, /丐姐/, /刀娘/, /雪萝/]},
    { name: "成男", value: 'bool', type:"体型", keyword:[/成男/, /道长/, /花哥/, /毒哥/, /琴爹/, /喵哥/, /军爷/, /苍爹/, /伞爹/, /二少/, /炮哥/, /丐哥/, /刀哥/, /大师/, /刀爷/, /刀爹/, /雪爹/]},
    { name: "正太", value: 'bool', type:"体型", keyword:[/正太/, /咩太/, /花太/, /秀太/, /毒太/, /呱太/, /琴太/, /喵太/, /狗太/, /策太/, /军太/, /小灯泡/, /盾太/, /伞太/, /叽太/, /炮太/, /丐太/, /刀太/, /秃太/, /雪娘/, /小和尚/]},
]
...
const schoolKeyword = [
    ...
    { name :'长歌', keywords: ["琴萝", "琴姐", "琴爹", "琴太", "鸽萝", "歌萝", "琴娘"] },
    { name :'天策', keywords: ["军萝", "军娘", "军爷", "军太", "狗太", "策太"] },
    { name :'藏剑', keywords: ["叽萝", "二小姐", "鸡萝", "二少", "叽太"] },
    { name :'少林', keywords: ["大师", "秃太", "小和尚", "小灯泡"] },
    { name :'丐帮', keywords: ["丐萝", "丐姐", "丐哥", "丐太"] },
    { name :'苍云', keywords: ["盾萝", "盾娘", "盾姐", "苍爹", "盾太"] },
    { name :'纯阳', keywords: ["咩萝", "道姑", "道长", "咩太"] },
    { name :'明教', keywords: ["喵萝", "喵姐", "喵哥", "喵太"] },
    { name :'唐门', keywords: ["炮萝", "炮姐", "炮哥", "炮太"] },
    { name :'霸刀', keywords: ["刀萝", "刀娘", "刀哥", "刀太", "刀爷", "刀爹"] },
    { name :'蓬莱', keywords: ["伞萝", "伞娘", "伞姐", "伞爹", "伞太"] },
    { name :'凌雪阁', keywords: ["雪萝", "雪爹", "雪娘", "大侠", "女侠"] },
]
